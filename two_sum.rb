...
Let's start by implementing the brute force solution. Write a method called bad_two_sum? that checks every possible pair.
...
How might sorting the array make the problem easier?
Write a second solution called okay_two_sum? that uses sorting. Make sure it works correctly.
...
Once you're finished, make sure you understand the time complexity of your solutions. Then call over your TA and show them what you've got. Defend to them why each of your solutions has the time complexity you claim it does.
